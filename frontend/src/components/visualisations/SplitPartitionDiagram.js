...
const SplitPartitionDiagram = ({splitRows, trainCount, testCount, seed, featureCols}) => {
    ...
    useEffect(() => {
        ...
        g.append('rect')
            ...
            .attr('fill', '#56B4E9').attr('stroke', 'none');
        g.append('text')
            .attr('x', dX + dW / 2).attr('y', -40 + dH / 2 + 1)
            .attr('text-anchor', 'middle').attr('dominant-baseline', 'central')
            .attr('font-size', 12).attr('font-weight', 'bold')
            .attr('fill', '#fff').attr('font-family', 'var(--font-mono)')
        ...
        sorted.forEach((row, i) => {
            ...
            g.append('circle')
                ...
                .attr('r', 0)
                .attr('fill', isTrain ? '#0072B2' : '#D55E00')
                .attr('opacity', 0.75)
                .attr('stroke', 'none')
        ...
        g.append('text')
            ...
            .attr('fill', '#E69F00').attr('font-family', 'var(--font-mono)')
