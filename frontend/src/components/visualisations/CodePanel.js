...
const CodePanelEditor = lazy(() => import('./CodePanelEditor'));
...
# repartition() in Step 2 restores parallelism.
...
const CodePanel = ({currentStep, onExecuteStep, data}) => {
    ...
    const themes = {
        dark: {label: 'Dark', bg: '#1e1e1e'},
        light: {label: 'Light', bg: '#ffffff'},
        oneDark: {label: 'One Dark', bg: '#282c34'},
    };
        ...
        <div className="code-panel"
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <span style={{color: 'var(--grey-500)', fontSize: '12px', fontFamily: 'var(--font-mono)'}}>
                        Step_{currentStep}_{activeTemplate.title.replace(/\s+/g, '_')}.py
                    </span>
                </div>

                {/* CodeMirror */}
                <Suspense fallback={<div style={{flex: 1, minHeight: '240px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--grey-500)', background: activeTheme.bg}}>Loading editor…</div>}>
                    <CodePanelEditor
                ...
                <div style={{
                    ...
                    <span style={{color: 'var(--grey-500)', fontSize: '12px'}}>
            ...
            <div style={{
                ...
                <p style={{margin: 0, color: 'var(--grey-800)'}}>
                    <strong>Task:</strong> {
                    activeTemplate.desc
                }
                </p>
